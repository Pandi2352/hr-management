...
import { Check, Loader2, Send, Share2, Undo2, Upload } from 'lucide-react';
 ...
 */
export function QuizLifecycleActions({ quiz, onChanged, onAssign }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5">
      ...
      {!canAssign && quiz.status !== 'IN_REVIEW' && quiz.status !== 'DRAFT' && (
